...
from neural_network_mult_layer import NeuralNetwork
...
class Genetic:
    ...
    def __init__(self):
        ...
        self.len_population = 3
        self.len_dad = 1
        self.population = self.Population()
        self.best_population = self.population

    def Individual(self):
        return NeuralNetwork([3,20,1])
    ...
    def Mutation(self,populations, learning_mutation=0.1):
        for population in populations[:(self.len_population - self.len_dad)]:
